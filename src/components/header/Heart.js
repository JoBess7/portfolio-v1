...
export default function Heart(props) {
    ...
    const {databaseController} = props;
    ...
    function onLiked() {
        if(localStorage.getItem("hasLiked") === "false") {
    ...
    useEffect(() => {
        ...
        if(localStorage.getItem("hasLiked") === null) {
